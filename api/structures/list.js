...
List.prototype.values = function (callback) {
    client.lrange(this.key, 0, -1, callback);
    return this;
}
...
List.prototype.range = function (start, end, callback) {
    ...
    client.lrange(this.key, start, end, callback);
    return this;
}
...
List.prototype.get = function (index, count, callback) {
    if (typeof count === 'function') {
        callback = count;
        client.lindex(this.key, index, callback);
    } else {
        client.lrange(this.key, index, index + count - 1, callback);
    }
    return this;
}
...
List.prototype.cap = function (length, keep_earliest, callback) {
    ...
    client.ltrim(this.key, start, end, callback);
    return this;
}
...
List.prototype.remove = function (value, count, callback) {
    ...
    client.lrem(this.key, count, value, callback);
    return this;
}
...
List.prototype.insertBefore = function (pivot, value, callback) {
    callback = callback || function () {};
    client.linsert(this.key, 'BEFORE', pivot, value, callback);
    return this;
}
...
List.prototype.insertAfter = function (pivot, value, callback) {
    callback = callback || function () {};
    client.linsert(this.key, 'AFTER', pivot, value, callback);
    return this;
}
...
List.prototype.set = function (index, value, callback) {
    callback = callback || function () {};
    client.lset(this.key, index, value, callback);
    return this;
}
...
List.prototype.shift = function (wait, callback) {
    if (typeof wait === 'function') {
        callback = wait;
        client.lpop(this.key, callback);
    } else {
        client.blpop(this.key, wait, callback);
    }
    return this;
}
...
List.prototype.pop = function (wait, callback) {
    if (typeof wait === 'function') {
        callback = wait;
        client.rpop(this.key, callback);
    } else {
        client.brpop(this.key, wait, callback);
    }
    return this;
}
...
List.prototype.unshift = List.prototype.lpush = function (values, callback) {
    ...
    if (Array.isArray(values)) {
        var multi = client.multi(), key = this.key;
        values.reverse().forEach(function (value) {
            multi.lpush(key, value);
        });
        multi.exec(callback);
    } else {
        client.lpush(this.key, values, callback);
    }
    return this;
}
...
List.prototype.push = List.prototype.add = function (values, callback) {
    ...
    if (Array.isArray(values)) {
        ...
        client.rpush(this.key, values, callback);
    }
    return this;
}
...
List.prototype.popShift = function (list, wait, callback) {
    ...
    if (typeof wait === 'function') {
        callback = wait;
        client.rpoplpush(this.key, list, callback);
    } else {
        client.brpoplpush(this.key, list, wait, callback);
    }
    return this;
}